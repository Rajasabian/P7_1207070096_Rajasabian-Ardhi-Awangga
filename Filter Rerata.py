...
# Membaca gambar
img1 = cv2.imread('gambar/siganteng.jpg')
img2 = cv2.imread('gambar/sadcat.jpeg')
...
for baris in range(0, m1 - 1):
    for kolom in range(0, n1 - 1):
        a1 = baris
        b1 = kolom
        jumlah = copyimg1[a1 - 1, b1 - 1] + copyimg1[a1 - 1, b1] + copyimg1[a1 - 1, b1 - 1] + \
...
for baris1 in range(0, m2 - 1):
    for kolom1 in range(0, n2 - 1):
        a1 = baris1
        b1 = kolom1
        jumlah = copyimg2[a1 - 1, b1 - 1] + copyimg2[a1 - 1, b1] + copyimg2[a1 - 1, b1 - 1] + \
